    ...
    public class UsuarioRepository : IUsuarioRepository
    {
        ...
        public List<Usuario> Mostrar()
        {
            try
            {
                ...
                return _ctx.Usuarios.Include(u => u.AlunosTurmas).ThenInclude(a => a.ObjetivosAlunos).ThenInclude(o=>o.Objetivo).Include(t=>t.ProfessoresTurmas).ToList();
        ...
        public Usuario BuscarPorId(Guid id)
        {
            try
            {
                return _ctx.Usuarios.Include(u => u.AlunosTurmas).ThenInclude(a => a.ObjetivosAlunos).FirstOrDefault(u=>u.Id==id);
            }
            catch (Exception ex)
            {
